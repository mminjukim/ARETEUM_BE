# Generated by Django 4.2.16 on 2024-09-20 18:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('체험', '체험'), ('주점', '주점'), ('마켓', '마켓')], max_length=10, verbose_name='카테고리')),
                ('introduction', models.CharField(blank=True, max_length=300, null=True, verbose_name='부스소개')),
